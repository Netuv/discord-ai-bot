    ...
    sections: [
      {
        ...
        body: `${topic} adalah salah satu topik yang lagi hangat dibicarakan di komunitas anime. Banyak yang ngomongin di berbagai forum dan media sosial. Sayangnya konten detail belum bisa digenerate otomatis — coba lagi nanti ya!`,
        image_query: topic,
        video_query: topic,
      },
    ],
